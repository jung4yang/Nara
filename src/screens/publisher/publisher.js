...
const DEVELOPERS = [
{
    id: 'dev_echo',
    name: 'Echo Studio',
    avatar: '/echo_avatar.png',
    cover: '/echo_cover.png',
    field: '내러티브 중심 비주얼노벨 전문',
    location: '대구',
    teamSize: '5인',
    experience: '4년',
    released: '1개',
    awards: '2회',
    summary: '심해와 정체성이라는 주제를 깊이 있게 풀어내는 스토리 중심 인디 스튜디오입니다.',
    phone: '010-9999-9999',
    email: 'contact@echostudio.kr',
    sns: ['Instagram @echo_studio', 'X @echo_dev'],
    github: 'echo-studio',
    engines: ['Unity'],
    aiTools: ['NARA', 'Midjourney'],
  },
  {
    id: 'dev_002',
    name: 'PixelForge',
